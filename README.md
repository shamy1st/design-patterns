...
* [Factory Method](https://github.com/shamy1st/design-pattern-factory) create objects without specifying the class of the object. / Shape(Circle, Rectangle), ShapeFactory
* [Abstract Factory]()
* [Builder]()
* [Prototype]()
* [Singleton]()
